...
const clickHandler = (event) => {
  ...
  if (clickCount % 3 == 0) {
    ...
    let productPriceDiscount = Number(productPrice).toFixed(2)/2;
    console.log({ productId, productPriceDiscount });
    price.textContent =
      (parseFloat(price.textContent)) + Math.round(productPriceDiscount)  +
      " $";
  } else {
